        ...
        try:
            ...
            if enr.results is not None and len(enr.results) > 0:
                ...
                for c in res_df.columns:
                    cl = c.lower().strip()
                    if cl in ('term', 'pathway'):
                        col_map[c] = 'Term'
                    elif cl in ('p-value', 'pvalue', 'p value'):
                        col_map[c] = 'P_value'
                    elif cl in ('adjusted p-value', 'adjusted pvalue', 'adjusted p-value (bh)', 'fdr'):
                        col_map[c] = 'Adjusted_P_value'
                    elif 'genes' in cl:
                        col_map[c] = 'Genes'
                    elif cl in ('overlap', 'hits', 'overlap/hits'):
                        col_map[c] = 'Overlap'
...
>>>>>>> 36dac97ee68629d8cd582bd0ddc6cdb44b468faf
    return fig